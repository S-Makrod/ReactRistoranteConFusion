                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                <Col>
                                    ...
                                    <Errors className="text-danger" model=".name" show="touched" messages={{minLength: "Must have minimum of three characters ", maxLength: "Must be 15 characters or less "}}/>
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Col>
                                    <Label htmlFor="comment">Your Comment</Label>
                                    <Control.textarea model=".comment" id="comment" name="comment" cols="12" rows="6" className="form-control"/>
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Col>
